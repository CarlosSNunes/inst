...
export default [
    ...
    new CardModel({
        ...
        description: 'Disponível em São Paulo, os beneficiários têm direito a atendimento clínico e pediátrico sem necessidade de agendamento prévio na Clínica Personal System dentro dos dias e horários de funcionamento das unidades.',
        category: 'beneficiario',
        id: 'consulta-facil',
        button: new ButtonModel({
            routerLink: '/carreiras/consulta-facil',
            text: 'SAIBA MAIS'
        })
    }),
    new CardModel({
    ...
    new CardModel({
        type: 'default',
        title: 'Nutricionista na Empresa',
        description: 'Com o objetivo de promover bons hábitos alimentares e uma vida mais saudável aos beneficiários, a Care Plus dispõe de um programa de atendimento nutricional realizado na empresa.',
        category: 'rh'
    }),
    new CardModel({
        type: 'default',
