...
export const bannersMock = [
    new BannerModel({
        ...
        nomeImagemDesktop: 'banner_marca.png',
        caminhoCompletoDesktop: "assets/img/banner_marca.png",
        caminhoMobile: "assets/img",
        nomeImagemMobile: 'banner_marca.png',
        caminhoCompletoMobile: "assets/img/banner_marca.png",
    ...
    new BannerModel({
        ...
        tempoExibicao: 5000,
        linkExterno: '0',
        rota: '/a-careplus/gestao-de-saude/programas-preventivos#cuidado-da-familia',
