export default [
    {
        ...
        description: `
            ...
            A autorização prévia para EXAMES se aplica a um determinado grupo de exames considerados de alta complexidade ou
            cuja indicação clínica depende de análise do histórico do paciente, tipo de patologia investigada, se já houve exame
            anteriormente realizado, dentre outros detalhes.
            </p>
            ...
            <ul class="disc m-t-22">
                <li>
                    ...
                    patologia a se investigar, acompanhada dos laudos dos exames iniciais necessários à decisão pela pesquisa
                    genética, conforme as diretrizes determinadas pela ANS, bem como outros exames especificados pela RN 167/2008;
                </li>
                <li>
                    <strong>Nos casos de exames de ressonância magnética e tomografia computadorizada,</strong> é necessário
                    encaminhar laudo de exames de radiografia ou ultrassonografia realizados anteriormente;
                </li>
                <li>
                    <strong>Para exames de ultrassonografias obstétricas e fetais</strong> para acompanhamentos gestacionais com
                    intervalos inferiores a 45 dias, apresentar também relatório de justificativa médica.
                </li>
            </ul>
        `
    },
    {
        title: 'Esterilização Voluntária',
        description: `
            <p class="sub-description no-margin">
    ...
    },
    {
        ...
        description: `
            ...
            <ul class="disc m-t-22">
                ...
                <li>
                    Para o DIU hormonal mirena, é necessário encaminhar também o Termo de Consentimento para Implante do DIU
                    assinado pela paciente. O termo está disponível no site do beneficiário da Care Plus, menu Impressos > Termo de
                    Consentimento.
                </li>
            </ul>
    ...
    },
    {
        ...
        description: `
            ...
            <ul class="disc m-t-22">
                ...
                <li>
                    Relatório do odontólogo responsável pela solicitação de internação para realização de procedimento odontológico
            ...
            <ul class="disc m-t-22">
                ...
                <li>
                    Relatório de endocrinologista e/ou nutricionista com histórico de tratamentos realizados e curva de peso ao
                    longo do tratamento;
                </li>
                <li>
                ...
                <li>
                    Laudos de exames laboratoriais e/ou de imagem que comprovem a existência de comorbidades (nos casos de IMC entre
                    35 e 39,9 kg/m2).
                </li>
            </ul>
            ...
            <ul class="disc m-t-22">
                ...
                <li>
                    Termo de Consentimento e Ciência com 60 dias de antecedência, assinado pelo(a) postulante e pelo(a) cônjuge, com
                    firma devidamente reconhecida, declarando ciência e expressa anuência à realização do procedimento e dando
                    vistas ao conhecimento dos riscos inerentes ao mesmo;
                </li>
                <li>
                    Pedido médico;
                </li>
                <li>
                    Relatório do profissional responsável pela avaliação psicológica postulante ou do casal, quando o profissional
                    psicólogo julgar necessário (somente no caso de vasectomia);
                </li>
                <li>
                    Indicação do processo anestésico a ser utilizado, observando-se que a <strong>vasectomia prevê aplicação de
    ...
    },
    {
        ...
        description: `
            <p class="sub-description no-margin">
            O Protocolo Oficial de Obstetrícia define três exames de ultrassonografia obstétrica simples como padrão numa
            ...
            <ol class="m-t-20">
                <li>
                    <span><strong>Prescrição médica</strong> datada em nome da usuária constando procedimento a ser realizado, dados
                        do profissional médico (nome, CRM, carimbo e assinatura), idade gestacional e hipótese diagnóstica ou CID;
                    </span>
                </li>
                <li>
                    <span><strong>Data e local</strong> previstos para realização do procedimento.
                    </span>
                </li>
            </ol>
            ...
            <p class="sub-description">
                ...
                haverá necessidade do envio da prescrição médica para análise.
            </p>
        `
    },
    {
        title: 'Diálise, hemodiálise, quimioterapia ou radioterapia',
        description: `
            <p class="sub-description no-margin">
            <strong>
    ...
    },
    {
        ...
        description: `
            ...
            <ul class="disc">
                ...
                <li>
                    Laudos de exames que amparam a indicação – radiografias, ressonâncias magnéticas, audiometrias, dentre outros
            ...
            <ul class="disc m-t-20">
                ...
                <li>
                    Encaminhamento ao profissional médico solicitante do tratamento para solicitação de novas sessões, se
                    necessário.
                </li>
            </ul>
    ...
    {
        title: 'Psicoterapia, Psicologia, Terapia Ocupacional e Nutrição',
        description: `
            <p class="sub-description no-margin">
            ...
            <ul class="disc">
                ...
                <li>
                    <strong>Para solicitações cujo CID informado dá direito a 40 sessões – </strong> relatório do médico. No caso de
                    CID F31 ou F33, é recomendável o envio do formulário psicoterapia F31 e F33 (menu Impressos/Downloads),
                    preenchido e assinado pelo beneficiário e seu psicólogo e/ou médico. Embora opcional, inclui informações que
                    poderão agilizar a análise dos processos de autorização, reembolso e prévia de reembolso. No caso dos
                    diagnósticos F31 e F33, é imprescindível que um médico faça o acompanhamento do paciente. Por este motivo, o
                    nome e CRM deste médico é informação obrigatória no formulário.
                </li>
            </ul>
        `
    },
    ...
    },
    {
        ...
        description: `
            ...
            <ul class="disc m-t-22">
                ...
                <li>
                    Para vacinas seriadas (mais de uma dose), será necessário apresentar a prescrição médica apenas na aplicação da
                    primeira dose, desde que no pedido contenha a quantidade de doses que deverão ser ministradas e realizadas no
                    mesmo prestador
                </li>
                <li>
                    O pedido médico é fundamental, pois algumas vacinas implicam em riscos para determinados grupos de pacientes –
    ...
    {
        title: 'Medicamentos Oncológicos Orais',
        description: `
            <p class="sub-description no-margin">
                De acordo com a RN 338, vigente desde 02/01/2014, todas as operadoras de saúde devem, diante de diretrizes
                pré-estabelecidas, fornecer aos beneficiários portadores de determinadas neoplasias, os medicamentos oncológicos
