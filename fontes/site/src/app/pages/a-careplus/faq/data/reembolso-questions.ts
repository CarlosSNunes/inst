export default [
    {
        title: 'Posso saber os valores do meu reembolso de meu plano ou acessar a tabela de reembolso?',
        description: `
            ...
            <p class="sub-description no-margin">
                ...
                vigor, possibilita que sejam acessadas as condições de cobertura de cada plano, instruções sobre a forma como se
                ...
                <table border="1" table="" cellspacing="0" cellpadding="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>8 X 600 X 0,52</td>
                            <td align="right">R$ 2.496,00</td>
                        </tr>
                        <tr>
                            <td>AUXILIAR</td>
                            <td align="right">180</td>
                            <td>8 X 180 X 0,52</td>
                            <td align="right">R$ 748,80</td>
                        </tr>
                        <tr>
                            <td>ANESTESIA</td>
                            <td align="right">500</td>
                            <td>8 X 500 X 0,52</td>
                            <td align="right">R$ 2.080,00</td>
                        </tr>
                        <tr>
                            <td>INSTRUM.</td>
                            <td align="right">60</td>
                            <td>8 X 60 X 0,52</td>
                            <td align="right">R$ 249,60</td>
                        </tr>
                    </tbody>
                </table>
            </div>
    ...
    {
        title: 'Limitações quantitativas para sessões de fisioterapia e acupuntura fora de rede credenciada',
        description: `
            <p class="sub-description no-margin">
    ...
    {
        title: 'Como solicitar seu reembolso?',
        description: `
            <p class="sub-description no-margin">
            <strong>
                Via web
    ...
    {
        title: 'Todos os planos da Care Plus preveem reembolso de despesas?',
        description: `
            <p class="sub-description no-margin">
                Sim! Obviamente, os valores de reembolso previstos crescem à medida que se incorporam prestadores hospitalares e
    ...
    {
        title: 'Qual o prazo para ser reembolsado?',
        description: `
            <p class="sub-description no-margin">
            ...
            <ul class="disc">
                <li>
                    <strong>
                        Prazo para reembolso de até 24 horas úteis (3 dias) -</strong> para consultas médicas, odontologia,
                    fisioterapia, fonoaudiologia, acupuntura, psicoterapia, psicologia, escleroterapia, vacinas, exames simples e de
                    alta complexidade, nutricionista e terapia ocupacional.
                </li>
                <li>
                    <strong>
    ...
    {
        title: 'Quando solicitar Nota Fiscal para Reembolso',
        description: `
            <p class="sub-description no-margin">
    ...
    {
        title: 'Em quais situações não cabe reembolso?',
        description: `
            <ul class="disc">
                <li>
                ...
                <li>
                    Atendimentos prestados por profissionais com habilitação médica e odontológica suspensa, cassada ou de
                    especialidade médica não reconhecida;
                </li>
                <li>
                ...
                <li>
                    Despesas que tenham sido caracterizadas por meio de relatórios ou apresentação de documentos que demonstrem não
                    serem objeto de cobertura por parte do plano contratado, ainda que apresentadas para tal;
                </li>
                <li>
                    Atendimento prestado por profissionais não inscritos no Conselho Federal de Medicina, Odontologia e
    ...
    {
        title: 'Como usar adequadamente o reembolso?',
        description: `
            <p class="sub-description no-margin">
                Os planos de saúde no Brasil, que inicialmente se dividiam claramente em SISTEMAS DE REDE e SISTEMAS DE LIVRE
            ...
            <p class="sub-description">
                ...
                Concedem, portanto, o benefício de se pesquisar valores e optar por profissionais cujos custos podem se adequar ao
                limite previsto e nos casos em que seus custos são superiores, dão ao colaborador a opção entre assumir parte deste
            ...
            <ul class="disc">
                <li>
                    ...
                    pagamento pré-datado é perfeitamente normal. O que não é passível de cobertura é o envio de mais de um recibo
                    para a mesma consulta. O correto é o envio de um único recibo. Os demais são usados para fins de Imposto de
                    Renda;
                </li>
                <li>
                    <strong>
                        Recibos de mais de um profissional -
                    </strong> a Clínica oferece a emissão de recibos de mais do que um profissional com valor fracionado para compor
                    o valor da consulta cobrada. Sugerimos agradecer, pedir um recibo só e lançar a diferença não reembolsada no
                    Imposto de Renda;
                </li>
                <li>
                    <strong>Recibos de serviços não realizados -</strong> a clínica oferece a emissão de um recibo de consulta e uma
                    nota de exames – não realizados - para compor o valor da consulta. Esta ação também é irregular. Nos tempos de
                    "Business Intelligence", a recepcionista da clínica lhe informa que na Care Plus ou qualquer outra empresa de
                    saúde tal código "passa". Provavelmente, eles ainda não foram alvo de alguma auditoria ou se foram não se obteve
                    uma forma de se comprovar irregularidade, ou ela não tem dimensão do que seu ato pode causar inclusive no
            ...
            <p class="sub-description">
                ...
                não foram criadas. Foram fatos reais. E infelizmente, o custo foi o emprego de alguns chefes de família, em
                determinados casos por responsabilidade direta, e em outros porque seus dependentes agiram sem terem a real dimensão
                dos seus atos junto às empresas de seus cônjuges.
            </p>
        `
    },
    {
    ...
    {
        title: 'O reembolso das despesas médicas e odontológicas é integral?',
        description: `
            <p class="sub-description no-margin">
    ...
    {
        title: 'O que pode ser utilizado para fins de imposto de renda?',
        description: `
            <p class="sub-description no-margin">
                Na prática, é necessário lançar na Declaração de Imposto de Renda da Pessoa Física a diferença entre o valor que foi
            ...
            <p class="sub-description">
                ...
                reembolso através da qual a empresa divide com o beneficiário parte das suas despesas com saúde. A coparticipação
                incide normalmente sobre despesas de consultas, exames e pronto socorro e é definida em valores fixos, em reais,
                para uso em rede, com um limitador máximo em percentual de 50% sobre a despesa e em percentuais no reembolso.
            </p>
        `
    },
    {
        title: 'Como funciona o sistema de coparticipação?',
        description: `
            <p class="sub-description no-margin">
    ...
    {
        title: 'Como abater as despesas não cobertas e a co-participação no imposto de renda?',
        description: `
            <p class="sub-description no-margin">
                A Care Plus paga a rede credenciada e processa mensalmente contra as empresas que possuem coparticipação aplicada em
    ...
    {
        title: 'Como fica a despesa de saúde do casal no IR de quem faz declaração em separado?',
        description: `
            <p class="sub-description no-margin">
    ...
    {
        title: 'Como declarar a despesa ocorrida em um ano e reembolsada no ano seguinte?',
        description: `
            <p class="sub-description no-margin">
            ...
            <ul class="disc">
                ...
                <li>
                    O beneficiário apresentou a conta em 2009 e foi parcialmente reembolsado
                    somente em 2009;
                </li>
                <li>
                    O beneficiário vai declarar a diferença apenas no IR de 2009, que será feito em 2010, pois o reembolso foi
                    apresentado e reembolsado parcialmente no ano seguinte ao da ocorrência da despesa e de seu pagamento ao
                    prestador.
                </li>
            </ul>
        `
    ...
    {
        title: 'Quais documentos são necessários encaminhar para reembolso de tratamentos apresentados em outra operadora?',
        description: `
            <p class="sub-description no-margin">
            ...
            <ul class="disc">
                <li>
                    ...
                    exclusões objeto do sinistro apresentado;
                </li>
                <li>
    ...
    {
        title: 'Como evitar surpresas na hora do reembolso?',
        description: `
            <p class="sub-description no-margin">
                Se a internação for eletiva, ou seja, houve um diagnóstico com indicação de uma cirurgia permitindo que seja
    ...
    {
        title: 'Posso passar em consulta com mais de um pediatra pelo livre escolha e solicitar reembolso?',
        description: `
            <p class="sub-description no-margin">
    ...
    {
        title: 'Qual o prazo considerado para retorno em consultas?',
        description: `
            <ul class="disc">
                <li>
                    No reembolso: <strong>16 dias;</strong>
                </li>
                <li>
                    Na rede credenciada: <strong>15 dias;</strong>
                </li>
            </ul>
        `
    }
